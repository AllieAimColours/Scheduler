...
const aura: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Cormorant_Garamond] font-semibold tracking-tight text-[#F5E9FF] leading-[1.05] [text-shadow:0_0_30px_rgba(196,160,255,0.35)]",
    body: "font-[Inter] font-light text-[#B8A8D4] leading-relaxed",
...
const bloom: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Playfair_Display] font-bold text-[#5C1F2E] tracking-tight leading-[1.1] [text-shadow:0_2px_20px_rgba(212,52,139,0.15)]",
    body: "font-[DM_Sans] text-[#A85577] leading-relaxed",
...
const luxe: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Bodoni_Moda] font-normal text-[#F5EFE0] tracking-[0.02em] leading-[1.05] [text-shadow:0_0_28px_rgba(212,168,83,0.25),0_2px_4px_rgba(0,0,0,0.4)]",
