...
const aura: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Cormorant_Garamond] font-semibold tracking-tight text-[#F5E9FF] leading-[1.05]",
...
const bloom: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Playfair_Display] font-bold text-[#5C1F2E] tracking-tight leading-[1.1]",
...
const luxe: TemplateDefinition = {
  ...
  classes: {
    ...
    heading: "font-[Bodoni_Moda] font-normal text-[#F5EFE0] tracking-[0.02em] leading-[1.05]",
